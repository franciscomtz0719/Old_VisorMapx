...
const ElementosConfiguracionesSensor = ({tarjeta,sensor }) => {
      ...
      <CCard className="shadow">
        ...
        {sensor.clase === "S" ? (
          ...
          <CCardBody>            
            ...
            <pre>
              <li>{`Dirección : ${sensor.elemento}.${sensor.clase}${sensor.index}`}</li>
              <li>{`Alias     : ${sensor.alias}`}</li>
              <li>{`Unidades  : ${sensor.unidades}`}</li>
...
export default ElementosConfiguracionesSensor;
